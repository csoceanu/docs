...
<.> Optional: Information about a Pipeline to be executed before the release Pipeline.
<.> Optional: The service account to use in the current Pipeline to gain elevated privileges.

...
. The `postActionsExecution` field contains information about the post-actions execution. This field was previously `finalProcessing`.
. The `processing` field contains information about the tenant release processing.

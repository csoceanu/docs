...
<.> An unstructured key used for providing data for the managed Release Pipeline.
<.> The number of days a Release should be kept after completion. This value is used to define the Release ExpirationTime for cleanup purposes.
...
. Click on the application component that is being released

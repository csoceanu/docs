...
* *Configure `ReleaseServiceConfig`:* The Managed Environment team can configure a `ReleaseServiceConfig` to define security policies, advisory repository, notification settings, and resource limits for release operations.
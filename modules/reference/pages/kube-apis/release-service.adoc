...
| *`serviceAccount`* __string__ | ServiceAccount is the name of the service account to use in the release PipelineRun to gain elevated privileges + |  | Pattern: `^[a-z0-9]([-a-z0-9]*[a-z0-9])?$` +
|===
...
| *`timeout`* __string__ | Timeout is value to use to override the tekton default Pipelinerun timeout + | "0" |
|===
